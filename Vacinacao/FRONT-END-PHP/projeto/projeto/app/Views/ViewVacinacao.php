    ...
    <script type="text/javascript">
      ...
      function drawChart() {
        var data = google.visualization.arrayToDataTable([
          ['Sexo', 'Total'],
          ['Homens', <?=$dados->total_masculino[0][0] ?>],
          ['Mulheres', <?=$dados->total_feminino[0][0] ?>],
        ]);
        var options = {
          chart: {
            title: 'Total de Vacinados por Sexo (em Milhões)',
            subtitle: '',
...
<div id="wrapper">
    ...
    <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
        ...
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="<?= site_url("ControllerVacinacao/index"); ?>">
                <img src="https://www.ssm.gov.mo/docs//18772//18772_c217bde127534df0b5f346ec55db76b5_000.png" style="margin-left: 8px; width:60px; height:60px;"   alt="LOGO">
            </a>
        ...
        <div id="borda-top" class="collapse navbar-collapse navbar-ex1-collapse"><br><br>
            ...
            <ul id="dashboardcenter" class="nav navbar-nav side-nav">
                <li>
                    <a rel="https://img.icons8.com/ios/2x/dashboard.png" data-toggle="collapse" ></i>
    ...
    <div id="page-wrapper">
        <div class="container-fluid">
            ...
            <div class="row" id="main" >
                <div id="bg-vacinados" class="col-sm-12 col-md-12 well" id="content">
                    <h1 style="font-family: 'Franklin Gothic Medium', 'Arial Narrow', Arial, sans-serif; text-align:center; color:white">Dashboard</h1>
                </div>
                <p style="font-family:sans-serif; text-align: center; font-size:30px; font-family: Arial"> Dados do estado do Rio Grande do Norte.</p>
            </div>
            <div id="page-wrapper">
        <div class="container-fluid">
            <!-- Page Heading -->
            <div class="row" id="main" >
                ...
                <div class="col-sm-12 col-md-12 well" id="content" style="margin-right: 10%;width: 40%;background-color: white">
                    <h5 style="font-family: arial; font-size: 16px; color: gray">Número de vacinados por dose</h5>
                    ...
                    <script type="text/javascript">
                        // http://www.chartjs.org/docs/#doughnut-pie-chart-introduction
                                    ...
                                    var data = [
                                        {
                                            value: <?=$dados->total_primeira_dose[0][0] ?>,
                                            color:"#FF5A5E",
                                            highlight: "#F7464A",
                                            label: "1º Dose"
                                        },
                                        {
                                            value: <?=$dados->total_segunda_dose[0][0] ?>,
                                            color: "#5882FA",
                                            highlight: "#2571a7",
                                            label: "2º Dose"
                                        },
        ...
        <!-- /.container-fluid -->
        <p style="font-size: 20px; color:black">Última atualização dos dados: <?=$dados->ultimo_dado[0][0] ?></p>
    </div>
        </div>
        <!-- /.container-fluid -->
    </div>
