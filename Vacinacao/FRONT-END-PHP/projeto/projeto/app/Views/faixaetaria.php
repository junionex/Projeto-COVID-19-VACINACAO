...
<div id="wrapper">
    ...
    <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
        ...
        <div id="borda-top" class="collapse navbar-collapse navbar-ex1-collapse"><br><br>
            ...
            <li></br>
                ...
                <li>
                    <a href="<?= site_url("home/faixaetaria"); ?>" > 
        ...
        <div class="container-fluid">
            ...
            <div class="row" id="main" >
                <div id="bg-vacinados" class="col-sm-12 col-md-12 well" id="content">
                    <h1 style="font-family: 'Franklin Gothic Medium', 'Arial Narrow', Arial, sans-serif; text-align:center; color:white">Faixa Etária</h1>
                </div>
                <p style="font-family:sans-serif; text-align: center; font-size:30px; font-family: Arial"> Dados de vacinados por faixa etária no estado do Rio Grande do Norte.</p>
            </div>
            <div id="page-wrapper">
        <div class="container-fluid">
            <!-- Page Heading -->
            <div class="row" id="main" >
                <div class="col-sm-12 col-md-12 well" id="content" style="margin-right: 10%;width: 80%;background-color: white;">
                    <h5 style="font-family: arial; font-size: 16px; color: gray">Total  de Vacinados por Faixa Etária (Mil)</h5>
                    <canvas id="myChart" width="1200px" height="350"></canvas>
                        ...
                        datasets: [
                            {
                                ...
                                data: [<?=$dados->resposta->idade_15_a_19[0][0]?>,
                                        ...
                                        <?=$dados->resposta->idade_95_a_99[0][0]?>,
    ...
    <p style="font-size: 20px; color:black">Última atualização dos dados: <?=$dados->ultimo[0][0] ?></p>
        </div>
        <!-- /.container-fluid -->
    </div>
    <!-- /#page-wrapper -->
